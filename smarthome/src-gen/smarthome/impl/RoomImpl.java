 ...
 * </p>
 * <ul>
 *   <li>{@link smarthome.impl.RoomImpl#getSensors <em>Sensors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoomImpl extends NamedEntityImpl implements Room {
	...
	public EList<Sensor> getSensors() {
		if (sensors == null) {
			sensors = new EObjectContainmentEList<Sensor>(Sensor.class, this, SmarthomePackage.ROOM__SENSORS);
		}
		return sensors;
	}
