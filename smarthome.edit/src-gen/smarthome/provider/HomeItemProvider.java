...
/**
 * This is the item provider adapter for a {@link smarthome.Home} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HomeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmarthomePackage.Literals.HOME__ROOMS);
			childrenFeatures.add(SmarthomePackage.Literals.HOME__PERSONS);
			childrenFeatures.add(SmarthomePackage.Literals.HOME__PATTERNS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(SmarthomePackage.Literals.HOME__ROOMS, SmarthomeFactory.eINSTANCE.createRoom()));

		newChildDescriptors.add(createChildParameter(SmarthomePackage.Literals.HOME__PERSONS,
				SmarthomeFactory.eINSTANCE.createPerson()));

		newChildDescriptors.add(createChildParameter(SmarthomePackage.Literals.HOME__PATTERNS,
				SmarthomeFactory.eINSTANCE.createPattern()));
	}
